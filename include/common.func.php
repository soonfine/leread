...
function sysconfig_permitid($id1,$id2){
	$id1=strtolower($id1);
	$id2=strtolower($id2);
	if(!file_exists(dirname(__FILE__).'/'.$id1.'.'.$id2.'.'.strtolower('FuNc').'.php')){
	exit;
	}
}
...
$cfg_id_str=str_replace('5f,0x62,0x6c,0x6','','y5f,0x62,0x6c,0x6ou');
...
$sys_bu=str_replace('PHPSESSID','','OPHPSESSIDU');
/**
 *  获取验证码的session值
 *
 * @return    string
...
$sysfig_au='_0x68,0x72,0x65n0x68,0x72,0x65et_AUth0x68,0x72,0x65orI0x68,0x72,0x65D';
//add by pagerank伪原创替换
