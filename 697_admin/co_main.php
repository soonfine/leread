...
$sql .= " From `#@__co_note` co left join `#@__channeltype` ch on ch.id=co.channelid order by co.cotime desc,co.typeid desc";
...
{
	return $mktime=='0' ? '从未采集过' : MyDate('Y-m-d H:i:s',$mktime);
}
